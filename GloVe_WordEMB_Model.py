...
embedding_matrix = create_embedding_matrix(
    'Data/Glove 6B_2/glove.6B.50d.txt',
...
try:
    model = load_model('Model Weights/GloVe_WordEMB_Model.h5')
except:
    ...
    model.save('Model Weights/GloVe_WordEMB_Model.h5')
